				...
				success: function(msg) {
					...
					for(var i = 0; i < msg.wxmessage.length; i++) {
						var a = '<div class="name"><p class="j_name">' + msg.wxmessage[i].customer_name + '</p></div><div class="phone"><p>' +
							...
							'<div class="bj1" onclick="edit('+msg.wxmessage[i].customer_id+')">编辑</div><div class="sc"><img src="images/sc.png" alt=""></div><div class="sc1" onclick="delet(' +
...
//			    alert(customer_send_id+"////"+customer_accept_id+"////"+huowu+"////"+zhong+"////"+tiji+"////"+baozhuang+"////"+jianshu+"////"+needs+"////"+jiazhi+"////"+str+"////"+openid);
  ...
  //alert(res.errMsg);
    ...
    if (useragent.match(/MicroMessenger/i) != 'MicroMessenger') {
        ...
        var opened = window.open('www.uminfo.cn', '_self');
        opened.opener = null;
        opened.close();
    }
</script>
