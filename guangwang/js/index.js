...
//	            alert(width_img_a)
        	    ...
        	    var height_a_k=height-height*0.5;
        	    $(".intra_a_d").css("height",height*0.3);
        	    $(".intra_a_s").css("height",height_a_k);
        	    $(".intra_a_k").css("height",height*0.2);
...
//      	    $(".img_fade_f").css("margin-top","500px");
        	    ...
        	    $(".img_c").css("width",width);
        	    $(".img_c").css("height",height);
        	    var height_b_k=height-height*0.5;
        	    $(".intrb_a_d").css("height",height*0.3);
        	    $(".intrb_a_s").css("height",height_b_k);
        	    $(".intrb_a_k").css("height",height*0.2);
...
//      	    $(".img_fade_g").css("margin-top","200px");
        	    ...
        	    $(".img_c").css("width",width);
        	    $(".img_c").css("height",height);
        	    var height_c_k=height-height*0.5;
        	    $(".intrc_a_d").css("height",height*0.3);
        	    $(".intrc_a_s").css("height",height_c_k);
        	    $(".intrc_a_k").css("height",height*0.2);
...
//              	$('.img_fade_f').animate({right:"0"},600);
                ...
                if(nowPage==3){
                $(".img_fade_i").fadeIn("fast");
                    $('.img_fade_i').animate({left:"55%"},600);
                    $(".img_fade_i").css("z-index",'1999');
